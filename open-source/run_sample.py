...
if __name__ == '__main__':
    ...
    parser.add_argument("--voc12_root", default='/data2/tiiktak/datasets/VOC2012/', type=str,
    ...
    parser.add_argument("--nce_bg_bg", type=str2bool, default=False)
    parser.add_argument("--nce_alpha", type=float, default=1.0)
    parser.add_argument("--nce_beta", type=float, default=1.0)
